...
type SubmitOrderRequest struct {
	...
	OrderType     *int32 `protobuf:"varint,14,opt,name=order_type,json=orderType" json:"order_type,omitempty"`
...
func (x *SubmitOrderRequest) GetCounterpartySegment() int32 {
	if x != nil && x.CounterpartySegment != nil {
		return *x.CounterpartySegment
	}
	return 0
}
...
type SubmitOrderResponse struct {
	...
	// Filled in for market orders, where the partner cannot know the price in
	// advance: quantity actually executed and the weighted average rate across
	// the trades of this submission. Empty for limit orders, whose fills arrive
	// on the trade stream.
	FilledQuantity *string `protobuf:"bytes,3,opt,name=filled_quantity,json=filledQuantity" json:"filled_quantity,omitempty"`
	AverageRate    *string `protobuf:"bytes,4,opt,name=average_rate,json=averageRate" json:"average_rate,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SubmitOrderResponse) GetFilledQuantity() string {
...
func (x *SubmitOrderResponse) GetAverageRate() string {
	if x != nil && x.AverageRate != nil {
...
func (x *OrderInfo) GetCounterpartySegment() int32 {
	if x != nil && x.CounterpartySegment != nil {
		return *x.CounterpartySegment
	}
	return 0
...
const file_forex_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14forex/v1/order.proto\x12\bforex.v1\"\xdf\x03\n" +
	...
	"\n" +
	"partner_id\x18\f \x01(\tR\tpartnerId\x121\n" +
	"\x14counterparty_segment\x18\r \x01(\x05R\x13counterpartySegment\x12\x1d\n" +
	"\n" +
	"order_type\x18\x0e \x01(\x05R\torderType\"\x8f\x01\n" +
	"\x13SubmitOrderResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12\x14\n" +
	"\x05cause\x18\x02 \x01(\tR\x05cause\x12'\n" +
	"\x0ffilled_quantity\x18\x03 \x01(\tR\x0efilledQuantity\x12!\n" +
	"\faverage_rate\x18\x04 \x01(\tR\vaverageRate\"\x88\x01\n" +
	...
	"\x06orders\x18\x01 \x03(\v2\x13.forex.v1.OrderInfoR\x06orders\"\xfc\x03\n" +
	"\tOrderInfo\x12\x19\n" +
	...
	"\torder_day\x18\r \x01(\tR\borderDay\x121\n" +
	"\x14counterparty_segment\x18\x0e \x01(\x05R\x13counterpartySegment\x12\x1d\n" +
	"\n" +
	"order_type\x18\x0f \x01(\x05R\torderType\"\xb4\x01\n" +
